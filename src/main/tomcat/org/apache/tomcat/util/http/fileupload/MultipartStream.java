...
public class MultipartStream {
    ...
    public static class ProgressNotifier {
        ...
        /**
         * Creates a new instance with the given event
         * and content length.
         *
         * @param pListener The event to invoke.
        ...
        /**
         * Called for notifying the event.
         */
     ...
     * @param boundary The token used for dividing the stream into
     *                 <code>encapsulations</code>.
     * @param pNotifier An object for calling the progress event, if any.
     *
     *
