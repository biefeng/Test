...
public class StandardContext extends ContainerBase
   ...
   /**
    ...
    /**
     * The set of application event class names configured for this
    ...
    /**
     * The set of instantiated application event event objects. Note that
     * SCIs and other code may use the pluggability APIs to add event
    ...
    /**
     * The set of instantiated application lifecycle event objects. Note that
     * SCIs and other code may use the pluggability APIs to add event
     * instances directly to this list before the application starts.
     */
    ...
    /**
     * The naming context event for this web application.
     */
    ...
    /**
     * Return the set of initialized application event event objects,
    ...
    /**
     * Store the set of initialized application event event objects,
     * in the order they were specified in the web application deployment
     * descriptor, for this application.
     *
     * @param listeners The set of instantiated event objects.
     */
    @Override
    ...
    /**
     * Add a event to the end of the list of initialized application event
     * listeners.
     */
    ...
    /**
     * Return the set of initialized application lifecycle event objects,
     * in the order they were specified in the web application deployment
     * descriptor, for this application.
     *
     * @exception IllegalStateException if this method is called before
    ...
    /**
     * Store the set of initialized application lifecycle event objects,
     * in the order they were specified in the web application deployment
     * descriptor, for this application.
     *
     * @param listeners The set of instantiated event objects.
    ...
    /**
     * Add a event to the end of the list of initialized application
     * lifecycle listeners.
     */
    ...
    /**
     * Return the set of application event class names configured
    ...
    /**
     * Remove the specified application event class from the set of
     * listeners for this application.
     *
     * @param listener Java class name of the event to be removed
     */
    @Override
    public void removeApplicationListener(String listener) {
        ...
        synchronized (applicationListenersLock) {
            ...
            // Make sure this event is currently present
            int n = -1;
            for (int i = 0; i < applicationListeners.length; i++) {
    ...
    public void removeWrapperLifecycle(String listener) {
        ...
        synchronized (wrapperLifecyclesLock) {
            ...
            // Make sure this lifecycle event is currently present
            int n = -1;
            for (int i = 0; i < wrapperLifecycles.length; i++) {
            ...
            // Remove the specified lifecycle event
            int j = 0;
            String results[] = new String[wrapperLifecycles.length - 1];
            for (int i = 0; i < wrapperLifecycles.length; i++) {
                if (i != n)
    ...
    public boolean listenerStart() {
        ...
        for (int i = 0; i < results.length; i++) {
            if (getLogger().isDebugEnabled())
                getLogger().debug(" Configuring event event class '" +
                    listeners[i] + "'");
            try {
