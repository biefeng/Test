 ...
 * </p>
 * 
 * This event must be declared in server.xml to be active.
 * 
 */
    ...
    public void lifecycleEvent(LifecycleEvent event) {
        try {
            ...
            if (Lifecycle.AFTER_START_EVENT.equals(event.getType()) &&
                ...
                // when the server starts, we register ourself as event for
                // all context
                // as well as container event event so that we know when new
