 ...
 * event that adds the standard DefaultServlet, JSP processing, and welcome
 * files.
 *
 * <p>
 ...
 * add this event, you must prevent Tomcat from applying any standard global
 * web.xml with ...
 *
 * <p>
...
public class Tomcat {
    ...
    /**
     * Return a event that provides the required configuration items for JSP
     ...
     * @return a event object that configures default JSP processing.
     */
     ...
     * expects a event to set it back to true.
     */
     ...
     * event sets the equivalent of conf/web.xml when the context starts.
     */
