...
public final class PasswdUserDatabase implements UserDatabase {
    ...
    /**
     * The UserConfig event with which we are associated.
     */
    private UserConfig userConfig = null;


    /**
     * Return the UserConfig event with which we are associated.
     */
    @Override
    ...
    /**
     * Set the UserConfig event with which we are associated.
     *
     * @param userConfig The new UserConfig event
     */
    @Override
