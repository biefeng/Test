...
//------------------------------------------------------------------------------
    ...
    /**
     * Initializes the map by creating the RPC channel, registering itself as a channel event
    ...
    protected void init(MapOwner owner, Channel channel, String mapContextName,
        ...
        //create an rpc channel and add the map as a event
        this.rpcChannel = new RpcChannel(this.mapContextName, channel, this);
        //add this map as a message event
