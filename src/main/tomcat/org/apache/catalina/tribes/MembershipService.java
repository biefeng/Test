...
public interface MembershipService {
     ...
     * the event will start to receive membership events.
    ...
    /**
     * Sets the membership event, only one event can be added.
     * If you call this method twice, the last event will be used.
     * @param listener The event
     */
    public void setMembershipListener(MembershipListener listener);
    
    /**
     * removes the membership event.
     */
