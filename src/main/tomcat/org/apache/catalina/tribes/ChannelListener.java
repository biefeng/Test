 ...
 * When a message is received, the Channel will invoke the channel event in a conditional sequence.
 * <code>if ( event.accept(msg,sender) ) event.messageReceived(msg,sender);</code><br>
...
public interface ChannelListener {
    ...
    /**
     * Invoked by the channel to determine if the event will process this message or not.
     * @param msg Serializable
     * @param sender Member
     * @return boolean
     */
