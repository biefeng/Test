 ...
 * 3. Membership event,listens for membership broadcasts<br>
...
public interface Channel {
     ...
     * Start and stop sequences can be controlled by these constants
     * This allows you to start separate components of the channel <br>
     * MBR_RX_SEQ - starts or stops the membership event. In a multicast implementation
    ...
    /**
     * Add a membership event, will get notified when a new member joins, leaves or crashes
     * <br>If the membership event implements the Heartbeat interface
    ...
    /**
     * Add a channel event, this is a callback object when messages are received
     * <br>If the channel event implements the Heartbeat interface
     * the <code>heartbeat()</code> method will be invoked when the heartbeat runs on the channel
    ...
    /**
     * remove a membership event, listeners are removed based on Object.hashCode and Object.equals
     * @param listener MembershipListener
     * @see MembershipListener
     */
    public void removeMembershipListener(MembershipListener listener);
    /**
     * remove a channel event, listeners are removed based on Object.hashCode and Object.equals
     * @param listener ChannelListener
     * @see ChannelListener
     */
