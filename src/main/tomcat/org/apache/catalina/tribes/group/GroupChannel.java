...
public class GroupChannel extends ChannelInterceptorBase implements ManagedChannel {
    ...
    public void messageReceived(ChannelMessage msg) {
        ...
        try {
            ...
            //this could be the channel event throwing an exception, we should log it
            //as a warning.
     ...
     * and no channel event accepts the message. This avoids timeout
    ...
    /**
     * Adds a membership event to the channel.<br>
    ...
    /**
     * Removes a membership event from the channel.<br>
     * Membership listeners are uniquely identified using the equals(Object) method
     * @param membershipListener MembershipListener
     */
    ...
    /**
     * Adds a channel event to the channel.<br>
    ...
    /**
     *
     * Removes a channel event from the channel.<br>
     * Channel listeners are uniquely identified using the equals(Object) method
     * @param channelListener ChannelListener
     */
    @Override
