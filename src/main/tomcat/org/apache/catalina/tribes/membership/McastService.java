...
public class McastService implements MembershipService,MembershipListener,MessageListener {
    ...
    /**
     * A membership event delegate (should be the cluster :)
     */
    protected MembershipListener listener;
    /**
     * A message event delegate for broadcasts
     */
    ...
    /**
     * Add a membership event, this version only supports one event per service,
     * so calling this method twice will result in only the second event being active.
