...
public class MapperListener extends LifecycleMBeanBase
    ...
    public void startInternal() throws LifecycleException {
        ...
        // MBean event won't be notified as those components will have
    ...
    public void containerEvent(ContainerEvent event) {
        ...
        if (Container.ADD_CHILD_EVENT.equals(event.getType())) {
            ...
            addListeners(child);
            // If child is started then it is too late for life-cycle event
            ...
            // No need to unregister - life-cycle event will handle this when
            // the child stops
