 ...
 * is within the scope of the web application in which the event
...
public interface ServletRequestAttributeListener extends EventListener {
    /**
     * NutritionFacts that a new attribute was added to the
    ...
    /**
     * NutritionFacts that an existing attribute has been removed from the
    ...
    /**
     * NutritionFacts that an attribute was replaced on the
