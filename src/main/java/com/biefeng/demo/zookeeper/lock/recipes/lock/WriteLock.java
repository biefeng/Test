 ...
 */
package com.biefeng.demo.zookeeper.lock.recipes.lock;
 ...
 *  some time later. <p/> You can register a event so that you are invoked
...
public class WriteLock extends ProtocolSupport {
    ...
    /**
     * register a different call back event
     * @param callback the call back instance
     */
