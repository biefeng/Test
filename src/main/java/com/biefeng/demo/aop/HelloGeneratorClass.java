...
public class HelloGeneratorClass implements Opcodes{
    ...
    public static byte[] generatorHelloClass() throws Exception {
        ...
        cw.visit(V1_7, ACC_PUBLIC + ACC_SUPER, "com/biefeng/demo/aop/Hello", null, "java/lang/Object", null);
        ...
        }
        {
            ...
            mv.visitFrame(Opcodes.F_FULL, 8,
                    new Object[] { "com/biefeng/demo/aop/Hello", Opcodes.INTEGER, "[Ljava/util/Map;",
            ...
            mv.visitLabel(l2);
            mv.visitFrame(Opcodes.F_FULL, 4, new Object[] { "com/biefeng/demo/aop/Hello", Opcodes.INTEGER,
   ...
   */
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> helloClass = myClassLoader.defineClass("com.biefeng.demo.aop.Hello", data);
            ...
            Class<?> stuClass = Thread.currentThread().getContextClassLoader().loadClass("com.biefeng.demo.aop.StudentServiceImpl");
